                    ...
                    returns = {
                        {
                            type = 'string',
                            name = 'paths',
                            description = 'The paths that the require function will check for c libraries in loves filesystem.'
                        }
                    }
                }
            }
                    ...
                    arguments = {
                        {
                            type = 'string',
                            name = 'paths',
                            description = 'The paths that the require function will check in loves filesystem.'
                        }
                    },
                }
            }
